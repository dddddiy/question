...
<template>
  <div class="home">
      ...
      <el-col :span="6">
        ...
        <div class="opera">
          ...
          <el-tooltip class="item" effect="dark" content="添加模板库" placement="bottom">
            <el-button icon="el-icon-upload" type="text" class="rightButton" @click="addtempbutten"></el-button>
          </el-tooltip>
          <el-tooltip class="item" effect="dark" content="查看模板库" placement="bottom">
            <el-button icon="el-icon-s-claim" type="text" class="rightButton" @click="openTemp"></el-button>
          </el-tooltip>
        </div> 
    ...
    <el-dialog title="编辑问卷" :visible.sync="dialogShow2" :close-on-click-modal="false" class="dialog">
      <el-form ref="form" :model="willAddWj" label-width="80px">
        <el-form-item label="问卷标题" style="width: 100%;" required>
          <el-input v-model="willAddWj.title" placeholder="请输入问卷标题" ></el-input>
        </el-form-item>
    ...
    <!--添加模板-->
    <el-dialog title="添加模板" :visible.sync="dialogtemp" :close-on-click-modal="false" class="dialog">
      <el-form ref="form" :model="addtemp" label-width="80px">
        <el-form-item label="问卷标题" style="width: 100%;" required>
          <el-input v-model="addtemp.title" placeholder="请输入问卷标题" ></el-input>
        </el-form-item>
        <el-form-item label="问卷描述" style="width: 100%;">
          <el-input v-model="addtemp.desc" type="textarea" placeholder="请输入问卷描述" rows="5"></el-input>
        </el-form-item>
      </el-form>

      <!-- <el-form-item label="题目类型" style="width: 100%;">
          <el-select v-model="addtemp.type" placeholder="请选择题目类型" @change="typeChange">
          <el-option
        ...
        <el-button type="primary" style="margin-left: 10px;" @click="addTemp">确定</el-button>
    </el-dialog>
    ...
    <el-dialog title="模板库" :visible.sync="tempDialog" :close-on-click-modal="false" class="dialog">
      <!-- <el-row>
        ...
        <el-col :span="8">
            <el-button style="margin-left: 5px;" @click="">搜索</el-button>
          </el-col>
      </el-row> -->
     ...
     <el-table-column label="删除">
        ...
        <el-link slot-scope="scope" type="primary" @click="deletTemp(scope.row)">删除</el-link>
     </el-table-column>
    </el-table>
